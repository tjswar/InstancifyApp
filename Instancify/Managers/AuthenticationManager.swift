...
class AuthenticationManager: ObservableObject {
    ...
    @Published var selectedRegion: AWSRegion = .usEast2
    ...
    private func revalidateSession() async {
        ...
        do {
            ...
            print("🔐 AuthManager: ❌ Session invalid")
        }
    }
    ...
    func updateRegion(_ newRegion: AWSRegion) async throws {
        ...
        print("🔐 AuthManager: Region changing to \(newRegion.rawValue)")
        ...
        // Reconfigure AWS with new region
        configureAWS(with: credentials)
        
        // Save new region
        try keychain.set(newRegion.rawValue, key: "region")
        
        print("🔐 AuthManager: ✅ Region changed successfully")
    }
    
    private func configureAWS(with credentials: AWSCredentials) {
        print("🔧 Configuring AWS with credentials...")
        ...
        print("✅ AWS configured with credentials")
    }
}
